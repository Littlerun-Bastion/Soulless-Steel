...
func setup(arena_ref, is_tutorial):
	...
	if is_tutorial:
		...
		set_chassis(PartManager.get_random_part_name("chassis_single"), SIDE.SINGLE)
		...
		set_head(PartManager.get_random_part_name("head"))
		set_chassis(PartManager.get_random_part_name("chassis_left"), SIDE.LEFT)
		set_chassis(PartManager.get_random_part_name("chassis_right"), SIDE.RIGHT)
